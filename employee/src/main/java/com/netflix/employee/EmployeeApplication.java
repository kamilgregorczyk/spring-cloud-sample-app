package com.netflix.employee;

import com.netflix.employee.models.Employee;
import com.netflix.employee.repositories.EmployeeRepository;
...
public class EmployeeApplication {
    ...
    public Docket swaggerApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.netflix.employee.controllers"))
